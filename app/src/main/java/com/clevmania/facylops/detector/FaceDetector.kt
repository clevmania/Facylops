...
import com.clevmania.facylops.overlay.FaceMapOverlay
...
class FaceDetector(private val faceOverlay: FaceMapOverlay) {

    private val mlFaceDetector = FaceDetection.getClient(
    ...
    private var faceDetectedListener: OnFaceDetectedListener? = null
    ...
    init {
        faceOverlay.addOnAttachStateChangeListener(object : View.OnAttachStateChangeListener {
    ...
    fun setonFaceDetectionFailureListener(listener: OnFaceDetectedListener) {
        faceDetectedListener = listener
    }
    ...
    private fun Frame.detectFaces() {
        ...
        mlFaceDetector.process(inputImage)
            .addOnSuccessListener { faces ->
                ...
                mainExecutor.execute {
                    faceOverlay.updateFaces(faceBounds,faces)
                }
            }
    ...
    private fun Face.toFaceBounds(frame: Frame): FaceBounds {
        ...
        val scaleX = faceOverlay.width.toFloat() / width
        val scaleY = faceOverlay.height.toFloat() / height
    ...
    private fun onError(exception: Exception) {
        faceDetectedListener?.onFailure(exception)
